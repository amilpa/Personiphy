...
import { CODE } from "../entercode/page";
...
export default function Big5PersonalityTequestions() {
  ...
  async function nextPage() {
    ...
    if (page == 4) {
      ...
      for (let i = 0; i < result.current.length; i++) {
        finalObj = {
          ...finalObj,
          [result.current[i].Qtype]: result.current[i].Ans,
        };
      }

      finalObj = [finalObj];
      finalObj = { name: session.user.name, code: code, result: finalObj };
    ...
    if (page != 4) {
      ...
      result.current = [...result.current, ...tempStorage.current];
      tempStorage.current = [];
      if (window) window.scrollTo({ top: 240, behavior: "smooth" });
    }
  }
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="w-full min-h-56 bg-[#33A474] mt-28 text-white text-3xl text-center pt-12 font-bold">
        Personality Test
      </div>
      ...
      <div className="mt-8 min-w-full min-h-[60%] ">
        <RadioButtons
          Qtype={questions[page][0].Qtype}
          title={questions[page][0].question}
          idtag="a"
          onSelect={handleSelect}
          checked={check}
        />
        <RadioButtons
          Qtype={questions[page][1].Qtype}
          title={questions[page][1].question}
          idtag="b"
          onSelect={handleSelect}
          checked={check}
        />
        <RadioButtons
          Qtype={questions[page][2].Qtype}
          title={questions[page][2].question}
          idtag="c"
          onSelect={handleSelect}
          checked={check}
        />
        <RadioButtons
          Qtype={questions[page][3].Qtype}
          title={questions[page][3].question}
          idtag="d"
          onSelect={handleSelect}
          checked={check}
        />
        <RadioButtons
          Qtype={questions[page][4].Qtype}
          title={questions[page][4].question}
          idtag="e"
          onSelect={handleSelect}
          checked={check}
        />
        <RadioButtons
          Qtype={questions[page][5].Qtype}
          title={questions[page][5].question}
          idtag="f"
          onSelect={handleSelect}
          checked={check}
        />
        <RadioButtons
          Qtype={questions[page][6].Qtype}
          title={questions[page][6].question}
          idtag="g"
          onSelect={handleSelect}
          checked={check}
        />
        <RadioButtons
          Qtype={questions[page][7].Qtype}
          title={questions[page][7].question}
          idtag="h"
          onSelect={handleSelect}
          checked={check}
        />
        <RadioButtons
          Qtype={questions[page][8].Qtype}
          title={questions[page][8].question}
          idtag="i"
          onSelect={handleSelect}
          checked={check}
        />
        <RadioButtons
          Qtype={questions[page][9].Qtype}
          title={questions[page][9].question}
          idtag="j"
          onSelect={handleSelect}
          checked={check}
        />
