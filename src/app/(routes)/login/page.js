  ...
  return (
      ...
      <div className="lg:w-1/2 sm:p-8">
        ...
        <form action="" className="flex flex-col">
          ...
          <button className="my-6 bg-blue-600 hover:bg-blue-700 text-white font-medium text-lg px-4 py-2 rounded-md" onClick={registration} >Login</button>
        </form>

        <p className="text-gray-500">Don't have an account? <Link href="#" className="text-blue-500 font-semibold underline">Sign up</Link></p>
